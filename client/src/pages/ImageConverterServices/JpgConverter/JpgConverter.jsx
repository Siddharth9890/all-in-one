...
export default function JpgCompressor() {
  ...
  const onSubmitImage = async () => {
    ...
    try {
      const response = await simplePostCall(
        "http://localhost:5000/api/images/jpg-to-png/convert",
        Picture
      );

      // await simplePostCall("http://localhost:5000/api/images/jpg-to-png/", {
      //   userData,
      //   data,
      // });
  ...
  const download = async () => {
    ...
    downloadFile(downloadedData, "temp.png");
  };
        ...
        <>
          <div className="max-w-7xl mx-auto px-4 py-8 my-4 sm:px-6  lg:px-8">
            <div className="max-w-3xl  mx-auto">
              {!showDownloadButton && (
                <>
                  <h3 className="text-center">Jpg Converter</h3>
                  <DropZone
                    maxFiles={1}
                    accept={"image/jpeg"}
